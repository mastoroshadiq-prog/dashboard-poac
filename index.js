...
app.listen(PORT, async () => {
  ...
  console.log('');
  console.log('   ✍️  SPK (WRITE):');
  console.log('   POST /api/v1/spk/                      - Buat SPK Header ✅ M-4.1');
  console.log('   POST /api/v1/spk/:id_spk/tugas         - Tambah Tugas ke SPK ✅ M-4.2');
  console.log('   POST /api/v1/spk/lapor-validasi        - Lapor Validasi [TODO]');
  console.log('   POST /api/v1/spk/lapor-aph             - Lapor APH [TODO]');
  console.log('   POST /api/v1/spk/lapor-sanitasi        - Lapor Sanitasi [TODO]');
  console.log('   GET  /api/v1/spk/daftar-tugas          - Daftar Tugas [TODO]');
  console.log('='.repeat(60));
});